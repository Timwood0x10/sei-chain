...
func NewParams(
	...
	return Params{
		...
		BaseFee:                  sdk.NewIntFromBigInt(sdkmath.NewIntFromUint64(baseFee).BigInt()),
...
func DefaultParams() Params {
	return Params{
		...
		BaseFee:                  sdk.NewIntFromBigInt(sdkmath.NewIntFromUint64(params.InitialBaseFee).BigInt()),
